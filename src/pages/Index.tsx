import { Shield, Clock, Users, TrendingDown, Star } from "lucide-react";
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={2} style={{ pointerEvents: "auto", position: "relative", zIndex: 50 }}>
            <motion.a
              ...
              className="inline-flex h-16 w-16 items-center justify-center rounded-full bg-[#25D366] text-white shadow-2xl shadow-[#25D366]/40 transition-transform hover:scale-110"
              aria-label="Solicitar pelo WhatsApp"
            >
