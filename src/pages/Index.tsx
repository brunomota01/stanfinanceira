    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <a id="whatsapp-header" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" style={{ pointerEvents: "auto", position: "relative", zIndex: 50 }}>
            <Button size="sm" className="gap-2 bg-accent text-accent-foreground hover:bg-accent/90 font-semibold cursor-pointer" style={{ pointerEvents: "auto", position: "relative", zIndex: 50 }}>
