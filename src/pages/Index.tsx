    ...
    <div className="min-h-screen bg-background">
      ...
      <header className="sticky top-0 z-40 border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
        <div className="container mx-auto flex h-16 items-center justify-between px-4">
          ...
          <a id="whatsapp-header" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
      ...
      <section className="relative overflow-hidden bg-secondary py-20 md:py-32">
        ...
        <div className="container relative mx-auto px-4 text-center">
          ...
          <motion.div variants={fadeUp} initial="hidden" animate="visible" custom={2}>
            <a id="whatsapp-hero" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
      ...
      <section className="bg-secondary py-16">
        <div className="container mx-auto px-4 text-center">
          ...
          <motion.div
            ...
            custom={2}
          >
            <a id="whatsapp-cta" href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer">
              <Button
                size="lg"
                className="gap-3 bg-[#25D366] text-white hover:bg-[#20bd5a] px-10 py-6 text-lg font-bold shadow-lg shadow-[#25D366]/30 transition-transform hover:scale-105"
              >
